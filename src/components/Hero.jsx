const Hero = () => {
    return (
        <div
            className="h-[calc(100svh-5rem)] bg-lila-900 flex justify-center "
            id="hero"
        >
            <img
                src="itgall-iso-claro.svg"
                className="w-80 h-3/5 opacity-40 absolute -bottom-10 lg:-left-96 lg:top-32 animate-spin-slow z-10"
            />
